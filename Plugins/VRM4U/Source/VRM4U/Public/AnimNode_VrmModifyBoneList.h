...
#include "AnimNode_VrmModifyBoneList.generated.h"
...
struct VRM4U_API FAnimNode_VrmModifyBoneList : public FAnimNode_SkeletalControlBase
{
	...
	TArray<FString> UseInputTransBoneList;

	FAnimNode_VrmModifyBoneList();
