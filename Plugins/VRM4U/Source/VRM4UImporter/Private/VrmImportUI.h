...
public:
	...
	/** Normalize axis for VRM1 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, AdvancedDisplay, Category = Mesh, meta = (ImportType = "StaticMesh|SkeletalMesh", DisplayName = "NormalizeForVRM1"))
	bool bVrm1Normalize = true;
	...
	#define VRM4U_MorphStrictMode true
#else
	#define VRM4U_MorphStrictMode false
#endif
