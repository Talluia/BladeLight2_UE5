...
static struct FScriptStruct_VRM4U_StaticRegisterNativesFVRMRetargetSrcAnimSequence
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("VRMRetargetSrcAnimSequence")),new UScriptStruct::TCppStructOps<FVRMRetargetSrcAnimSequence>);
	}
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FVRMRetargetSrcAnimSequence_Statics::NewProp_AnimSequence = { "AnimSequence", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FVRMRetargetSrcAnimSequence, AnimSequence), Z_Construct_UClass_UAnimSequenceBase_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FVRMRetargetSrcAnimSequence_Statics::NewProp_AnimSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVRMRetargetSrcAnimSequence_Statics::NewProp_AnimSequence_MetaData)) };
	...
	UScriptStruct* Z_Construct_UScriptStruct_FVRMRetargetSrcAnimSequence()
	{
		...
		if (!ReturnStruct)
		{
			UECodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FVRMRetargetSrcAnimSequence_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FVRMRetargetSrcAnimSequence_Hash() { return 772722985U; }
