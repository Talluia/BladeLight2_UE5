...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UVRM4UImporterFactory()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UVRM4UImporterFactory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UVRM4UImporterFactory, 2106259833);
