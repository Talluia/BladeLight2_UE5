...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAnimGraphNode_VrmSpringBone()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimGraphNode_VrmSpringBone_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimGraphNode_VrmSpringBone, 3322116663);
