...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UVrmAssetListThumbnailRenderer()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UVrmAssetListThumbnailRenderer_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UVrmAssetListThumbnailRenderer, 2743054522);
