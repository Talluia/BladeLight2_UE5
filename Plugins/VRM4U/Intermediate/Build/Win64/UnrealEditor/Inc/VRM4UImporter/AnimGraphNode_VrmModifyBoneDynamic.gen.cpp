...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAnimGraphNode_VrmModifyBoneDynamic()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimGraphNode_VrmModifyBoneDynamic_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimGraphNode_VrmModifyBoneDynamic, 3121995788);
	template<> VRM4UIMPORTER_API UClass* StaticClass<UAnimGraphNode_VrmModifyBoneDynamic>()
	{
		return UAnimGraphNode_VrmModifyBoneDynamic::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimGraphNode_VrmModifyBoneDynamic(Z_Construct_UClass_UAnimGraphNode_VrmModifyBoneDynamic, &UAnimGraphNode_VrmModifyBoneDynamic::StaticClass, TEXT("/Script/VRM4UImporter"), TEXT("UAnimGraphNode_VrmModifyBoneDynamic"), false, nullptr, nullptr, nullptr);
