...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_OpaqueTwoSided = { "OpaqueTwoSided", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVrmImportMaterialSet, OpaqueTwoSided), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_OpaqueTwoSided_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_OpaqueTwoSided_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_Translucent = { "Translucent", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVrmImportMaterialSet, Translucent), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_Translucent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_Translucent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_TranslucentTwoSided = { "TranslucentTwoSided", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVrmImportMaterialSet, TranslucentTwoSided), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_TranslucentTwoSided_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVrmImportMaterialSet_Statics::NewProp_TranslucentTwoSided_MetaData)) };
	...
	UClass* Z_Construct_UClass_UVrmImportMaterialSet()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UVrmImportMaterialSet_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UVrmImportMaterialSet, 3961144265);
