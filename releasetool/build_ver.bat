...
if %UE4VER% == 5.0EA (
  call "E:\Program Files\Epic Games\UE_5.0EA\Engine\Binaries\DotNET\UnrealBuildTool\UnrealBuildTool.exe" -projectfiles -project=%UPROJECT% -game -rocket -progress
) else (
...
if %tmpOldFlag% == TRUE (
del "../Plugins\VRM4U\Source\VRM4U\Private\VRM4U_VMCSubsystem.cpp"
del "../Plugins\VRM4U\Source\VRM4U\Public\VRM4U_VMCSubsystem.h"
)
